/**
 * Solution calculator parameters are stored as a JSON string in Convex.
 * Legacy Neon import sometimes double-encoded them; also some default files
 * wrap values as `{ parameters: ... }`. These helpers normalize both.
 */
